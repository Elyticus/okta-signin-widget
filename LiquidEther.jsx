/** LiquidEther.jsx — Browser/CDN build (no imports).
 * Requires React 18 UMD and THREE UMD loaded via <script> on the page.
 * Exposes window.LiquidEther for use in JSX.
 */

(function (global) {
  const { useEffect, useRef } = React; // from CDN
  ...
  function LiquidEther({
    ...
    style = {},
    className = "",
    // Disable demo/auto movement by default
    autoDemo = false,
    autoSpeed = 0.5,
    autoIntensity = 2.2,
